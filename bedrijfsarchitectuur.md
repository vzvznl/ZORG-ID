...
<figure><img src=".gitbook/assets/image (1) (1) (1) (1).png" alt=""><figcaption><p>Smartcard identiteit</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (1) (1) (1) (1) (1).png" alt=""><figcaption><p>ZORG-ID Kaders, richtlijnen en standaarden</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (19).png" alt=""><figcaption><p>End-user use cases</p></figcaption></figure>

<table><thead><tr><th width="202">Use-case</th><th>Omschrijving</th><th>Betrokken actoren</th></tr></thead><tbody><tr><td><a href="gebruikersscenarios/end-user/zid-uc-eu-001-open-sessie-authenticatie.md">ZID-UC-EU-001</a></td><td>Open Sessie (authenticatie)</td><td><ul><li>Zorgtoepassing</li><li>(Zorg)medewerker</li></ul></td></tr><tr><td><a href="gebruikersscenarios/end-user/zid-uc-eu-002-scan-wid.md">ZID-UC-EU-002</a></td><td>Scan WID</td><td><ul><li>Zorgtoepassing</li><li>(Zorg)medewerker</li></ul></td></tr><tr><td>ZID-UC-EU-003</td><td>Ophalen Token</td><td><ul><li>Zorgtoepassing</li></ul></td></tr><tr><td>ZID-UC-EU-004</td><td>Ondertekenen Token</td><td><ul><li>Zorgtoepassing</li></ul></td></tr><tr><td><a href="gebruikersscenarios/end-user/zid-uc-eu-005-registreren-met-uzi-pas.md">ZID-UC-EU-005</a></td><td>Registreren met UZI-pas</td><td><ul><li>Zorgtoepassing</li><li>(Zorg)medewerker</li></ul></td></tr></tbody></table>
...
| (Mobiel) Device               | Een fysiek (mobiel) apparaat , software of een (geautomatiseerd) proces. Devices hebben een Digitale Identiteit nodig voor informatiebeveiligingsfuncties en kunnen aan een Persoon gekoppeld of toegekend worden.                                                                                                                                                                                                                          |
...
| Persoon                       | Een persoon van vlees en bloed die rechten en plichten kan hebben. Zie ook zijn bevoegdheid.                                                                                                                                                                                                                                                                                                                                                |
